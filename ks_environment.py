...
class MessageDisplay():
    ...
    def __init__(self, name, bg, msg, filename, font_size, font_color, origin=(0, 0)):
        ...
        self.bg = bg
        self.msg = msg
        self.font = pygame.font.Font(root.fonts + filename, font_size)
        self.color = font_color
        self.img_srf = self.font.render(self.msg, False, self.color)
    ...
    def show_on_collide(self, mouse_xy, collision_item):
        """Show the message upon collision. Have options to choose if msg hovers on mouse, on object, or other."""
        if collision_item.rect.collidepoint(mouse_xy):
            self.rect.center = (mouse_xy[0], mouse_xy[1]+20)
